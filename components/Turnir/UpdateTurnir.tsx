...
const UpdateTurnir = (props: Props) => {
                                ...
                                try {
                                    ...
                                    if ("err" in res) {
                                        toast({
                                            title: "Greška",
                                            description:
                                                "Došlo je do greške prilikom ažuriranja turnira!",
                                            status: "error",
                                            duration: 5000,
                                            isClosable: true,
                                        });
                                        ...
                                        toast({
                                            title: "Uspešno izmenjen turnir",
                                            description: `Turnir je uspešno izmenjen u bazi!`,
                                            status: "success",
                                            duration: 5000,
                                            isClosable: true,
                                        });
